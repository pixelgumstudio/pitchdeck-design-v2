  ...
  return (
    <div className="bg-white">
      <div className="w-full laptop:max-w-[1152px] mx-auto px-4 tablet:px-6 laptop:px-8 desktop:px-0 text-center pt-[40px] tablet:pt-[80px]">
        <div className="w-full laptop:max-w-[1024px] text-left text-32 font-bold tablet:text-48 desktop:text-64">
          ...
          <div className="w-full max-w-[800px] mt-8 font-normal">
            <h2 className="text-[#414143] text-16 tablet:text-20 laptop:text-24">
              Browse a list of winning pitch deck examples from deck that has raised $100bn in funds. Make your pitch deck and Purchase templates  
            </h2>
          </div>
        </div>
      </div>
